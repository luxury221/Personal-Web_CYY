/* CYY companion + AI systems enhancement loader.
   ...
   current research-console motion system, portfolio storytelling, visual evidence,
   grounded project showcases, final QA and the local Research Assistant. */
(() => {
  ...
  [
    ...
    'styles-showcase-v5.css?v=20260904.1',
    'styles-final-v6.css?v=20260904.1'
  ].forEach((href) => {
  ...
  const sources = [
    ...
    'showcase-v5.js?v=20260904.1',
    'showcase-v5-guard.js?v=20260904.1',
    'final-v6.js?v=20260904.1',
